      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-9">
          ...
          <div class="slideshow single-slider owl-carousel">
            <div class="item"> <a href="#"><img class="img-responsive" src="{{asset('fronted/image/slider.jpg')}}" alt="banner 1" /></a> </div>
            <div class="item"> <a href="#"><img class="img-responsive" src="{{asset('fronted/image/slider.jpg')}}" alt="banner 2" /></a> </div>
            <div class="item"> <a href="#"><img class="img-responsive" src="{{asset('fronted/image/slider.jpg')}}" alt="banner 3" /></a> </div>
          </div>
          <!-- Slideshow End-->
		  ...
		  @for($i=0; $i<7; $i++)
            <div class="product-thumb clearfix">
              <div class="image"><a href="product.html"><img src="{{asset('fronted/image/product.jpg')}}" alt="تی شرت کتان مردانه" title="تی شرت کتان مردانه" class="img-responsive" /></a></div>
              <div class="caption">
