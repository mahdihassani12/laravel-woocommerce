     			...
     			<div class="row">
                         <form method="post" action="">
          				...
          				<div class="col-md-6 form-group">
          					...
          					<input type="text" name="firstName" id="name" class="form-control" placeholder="{{ trans('labels.name') }}">
          				</div>
          				<div class="col-md-6 form-group">
          					<label for="lastName">{{ trans('labels.lastname') }}</label>
          					<input type="text" name="lastName" id="lastName" class="form-control" 
          							placeholder="{{ trans('labels.lastname') }}">
          				</div>
          				<div class="col-md-6 form-group">
          				...
          				<div class="col-md-6 form-group">
          					...
          					<input type="text" name="subject" id="subject" class="form-control" 
          							placeholder="{{ trans('labels.subject') }}">
          				</div>
          				<div class="col-md-12 form-group">
          					<label for="message">{{ trans('labels.message') }}</label>
          					<textarea name="message" id="message" class="form-control" 
          								placeholder="{{ trans('labels.message') }}"	cols="10" rows="8"></textarea>
          				</div>
