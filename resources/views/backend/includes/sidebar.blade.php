    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-right image">
          <img src="{{asset('public/uploads/users')}}/{{$user->photo}}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="@if(isset($data['p_tab']) and  $data['p_tab']=="post") active @endif treeview">
         ...
         <li @if(isset($data['tab']) and  $data['tab']=="comments") class="active" @endif>
        ...
        <li @if(isset($data['tab']) and  $data['tab']=="slider") class="active" @endif>
         ...
         <li @if(isset($data['tab']) and  $data['tab']=="download") class="active" @endif>
          ...
          <li @if(isset($data['tab']) and  $data['tab']=="learning") class="active" @endif>
          <a href="{{ route('learnings.index') }}">
            <i class="fa fa-pen"></i><span>{{ trans('labels.learning') }}</span>
          </a>
        </li>


        <li @if(isset($data['tab']) and  $data['tab']=="order") class="active" @endif>
          <a href="{{ asset('orders/views') }}">
            <i class="fas fa-truck"></i> <span>{{ trans('labels.orders') }}</span>
          </a>
        </li>
		
		 <li @if(isset($data['tab']) and  $data['tab']=="request") class="active" @endif>
          <a href="{{ route('requests.index') }}">
            <i class="fas fa-comment-dots"></i> <span>{{ trans('labels.requests') }}</span>
          </a>
        </li>
        ...
        <li @if(isset($data['tab']) and  $data['tab']=="request_text") class="active" @endif>
          <a href="{{asset('request_text')}}">
            <i class="fa fa-th"></i> <span> ویرایش  درخواست محصول</span>
            <span class="pull-left-container">
            </span>
          </a>
        </li>
        
          <li @if(isset($data['tab']) and  $data['tab']=="ads") class="active" @endif>
          <a href="{{asset('ads')}}">
            <i class="fa fa-th"></i> <span>{{trans('labels.ads')}}</span>
            <span class="pull-left-container">
            </span>
          </a>
        </li>
