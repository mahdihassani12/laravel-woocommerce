       ...
       <form method="get" action="{{asset('products')}}">
        <div class="row">
          <div class="col-md-4" style="padding-left:0px">
           <input type="text" name="search" value="<?php if(isset($data['search'])): echo $data['search']; endif;?>" class="form-control" placeholder="{{trans('labels.search_product_name_or_code')}}" >
          </div>
          <div class="col-md-2"> 
           <input type="submit" name="" value="{{trans('labels.search')}}" class="form-control btn btn-primary">
           </div>
        </div>      
       </form> 
    </div>
              ...
              <table class="table">
                ...
                @foreach($products as $pr)
                	<tr>
	                  <!-- drag handle -->
	                  <!-- todo text -->
	                   <td class="text"><img src="{{asset('public/uploads/products')}}/{{$pr->feature_image}}" style="width: 60px;">
