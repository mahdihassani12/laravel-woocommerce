...
@section('main_content')
	...
	<section class="content-header">
		<h3 class="box-title">{{ trans('labels.learning_edit') }}</h3>
 	</section>
 	...
 	<section class="content">
 		<div class="row">
 			<div class="col-md-12">
 				...
 				<form action="{{ route('learnings.update',$learning->id) }}" method="post" enctype="multipart/form-data" style="background: #fff; border-radius: 5px; padding:10px; ">
			      	@csrf
			      	@method('PUT')
			        <div class="form-group">
			          <input type="text" class="form-control" name="title" value="{{ $learning->title }}" >
			        </div>
			        <div class="row">
			          <div class="col-md-9">

                        <div class="form-group">
                           <textarea name="excerpt" placeholder="{{trans('labels.excerpt')}}" class="form-control" rows="6">{{$learning->excerpt}}</textarea>         
                        </div>


				        <div>
				          <textarea class="form-control summernote" name="description" rows="10" 
				          			cols="10">{{ $learning->description }}</textarea>
				        </div>

                         <div class="form-group">
                          حجم فایل: {{ number_format($learning->size / 1048576,2).'MB' }}
					   ...
					   <div class="col-md-3">
			        	...
			        	<img src='{{ asset("public/uploads/learning_images/$learning->feature_image") }}' style="max-width: 100%">
